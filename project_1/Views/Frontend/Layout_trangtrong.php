      ...
      <script defer type="text/javascript">
       ...
       <script>
         ...
         
         {
             ...
             var y= isWhiteSpace(x.name.value);
         
             var dc = isWhiteSpace(x.address.value);
         
             if(y==true ||x.name.value =="")
             ...
             if(dc==true || x.address.value.length =="")
             ...
             if(x.phone.value.length < 8 || x.phone.value.length > 11)
