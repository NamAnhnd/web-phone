            ...
            <div class="module_pro_all">
                        ...
                        <div class="grids">
                            <div class="grids_in">
                                <div class="content">
                                    ...
                                    <div class="add_card">
                                        <a href="index.php?controller=cart&action=add&id=<?php echo $row->product_id ?>">
                ...
                <nav aria-label="Page navigation example" style="text-align:center">
                           <ul class="pagination">
                              ...
                              <?php for($i = 1;$i<=$one;$i++): ?>
                              <li  class="page-item"><a class="page-link"style=" color:black" href="index.php?controller=product&action=product&id=<?php echo $category->id ?>&page=<?php echo $i ?>"><?php echo $i; ?></a></li>
